...
function removeWeekends(days) {
	dayToCheck = String(days);
	var sunday = dayToCheck.indexOf("Sun");
	var saturday = dayToCheck.indexOf("Sat");
	if (sunday != '0' && saturday != '0') {
		return days;
	}
}
...
CalendarPicker.prototype._insertDaysIntoGrid = function () {
    ...
    arrayOfDays = arrayOfDays.filter(removeWeekends);
